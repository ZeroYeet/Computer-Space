...
<p class="text-[10px] font-bold text-on-surface-variant tracking-widest uppercase font-label">Loại</p>
<p class="text-xl font-headline font-bold text-primary">2.85 GHz</p>
</div>
<div class="bg-surface-container p-4">
<p class="text-[10px] font-bold text-on-surface-variant tracking-widest uppercase font-label">Dung lượng</p>
<p class="text-xl font-headline font-bold text-primary">24GB GDDR6X</p>
</div>
<div class="bg-surface-container p-4">
<p class="text-[10px] font-bold text-on-surface-variant tracking-widest uppercase font-label">Chuẩn kết nối</p>
<p class="text-xl font-headline font-bold text-primary">384-BIT</p>
</div>
<div class="bg-surface-container p-4">
<p class="text-[10px] font-bold text-on-surface-variant tracking-widest uppercase font-label">Tốc độ</p>
...
<span class="uppercase text-on-surface-variant">Loại ổ cứng</span>
<span class="font-bold">16,384</span>
</li>
<li class="flex justify-between text-sm">
<span class="uppercase text-on-surface-variant">Dung lượng</span>
...
<ul class="space-y-4 font-label">
<li class="flex justify-between text-sm">
<span class="uppercase text-on-surface-variant">Chuẩn kết nối</span>
<span class="font-bold">21 GBPS</span>
</li>
<li class="flex justify-between text-sm">
<span class="uppercase text-on-surface-variant">Kích cỡ</span>
<span class="font-bold">GDDR6X</span>
</li>
<li class="flex justify-between text-sm">
<span class="uppercase text-on-surface-variant">Tốc độ đọc/ghi</span>
