...
<input class="w-full bg-surface-container-lowest border-none text-on-surface text-sm p-3 pl-10 focus:ring-1 focus:ring-primary-fixed-dim transition-all outline-none rounded-DEFAULT" id="email" placeholder="tên đăng nhập..." type="username"/>
</div>
</div>
<!-- Password Input -->
<div class="space-y-1.5">
...
<a class="text-[10px] font-bold uppercase tracking-widest text-outline hover:text-primary transition-colors" href="#">Quên mật khẩu</a>
</div>
<div class="relative group">
