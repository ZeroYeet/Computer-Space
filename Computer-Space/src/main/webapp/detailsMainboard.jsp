...
<span class="text-2xl font-black text-[#00d4ff] tracking-tighter italic font-headline">Computer Space</span>
...
<a class="text-slate-400 hover:text-[#a8e8ff] transition-all duration-300" href="#">Đăng nhập</a>
<a class="text-[#00d4ff] hover:brightness-110 transition-all duration-300" href="#">Đăng kí</a>
</div>
</div>
<!--sau khi đăng nhập -->
<a class="flex items-center gap-3 pl-2 border-l border-slate-800" href='#'>
<div class="flex flex-col items-end">
<span class="text-white font-['Space_Grotesk'] uppercase tracking-widest text-[13px] font-bold transition-all">tên người dùng</span>
</div>
...
<p class="text-[10px] font-bold text-on-surface-variant tracking-widest uppercase font-label">Kích thước</p>
<p class="text-xl font-headline font-bold text-primary">2.85 GHz</p>
</div>
<div class="bg-surface-container p-4">
<p class="text-[10px] font-bold text-on-surface-variant tracking-widest uppercase font-label">Socket</p>
<p class="text-xl font-headline font-bold text-primary">24GB GDDR6X</p>
</div>
<div class="bg-surface-container p-4">
<p class="text-[10px] font-bold text-on-surface-variant tracking-widest uppercase font-label">Số khe RAM</p>
<p class="text-xl font-headline font-bold text-primary">384-BIT</p>
</div>
<div class="bg-surface-container p-4">
<p class="text-[10px] font-bold text-on-surface-variant tracking-widest uppercase font-label">Hỗ trợ</p>
...
<span class="uppercase text-on-surface-variant">Socket</span>
<span class="font-bold">16,384</span>
</li>
<li class="flex justify-between text-sm">
<span class="uppercase text-on-surface-variant">Kích thước</span>
<span class="font-bold">128 (3RD GEN)</span>
</li>
<li class="flex justify-between text-sm">
<span class="uppercase text-on-surface-variant">Số khe cắm RAM</span>
<span class="font-bold">512 (4TH GEN)</span>
</li>
<li class="flex justify-between text-sm">
<span class="uppercase text-on-surface-variant">Dung lượng RAM tối đa</span>
...
<ul class="space-y-4 font-label">
<li class="flex justify-between text-sm">
<span class="uppercase text-on-surface-variant">Hỗ trợ CPU</span>
<span class="font-bold">21 GBPS</span>
</li>
<li class="flex justify-between text-sm">
<span class="uppercase text-on-surface-variant">Số PCIe</span>
<span class="font-bold">GDDR6X</span>
</li>
<li class="flex justify-between text-sm">
<span class="uppercase text-on-surface-variant">Số cổng SATA</span>
<span class="font-bold">1,008 GB/S</span>
</li>
<li class="flex justify-between text-sm">
<span class="uppercase text-on-surface-variant">Số khe M2</span>
