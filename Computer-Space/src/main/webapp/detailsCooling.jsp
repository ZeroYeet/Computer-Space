...
<p class="text-[10px] font-bold text-on-surface-variant tracking-widest uppercase font-label">Kích thước tản</p>
<p class="text-xl font-headline font-bold text-primary">2.85 GHz</p>
</div>
<div class="bg-surface-container p-4">
<p class="text-[10px] font-bold text-on-surface-variant tracking-widest uppercase font-label">Số quạt</p>
<p class="text-xl font-headline font-bold text-primary">24GB GDDR6X</p>
</div>
<div class="bg-surface-container p-4">
<p class="text-[10px] font-bold text-on-surface-variant tracking-widest uppercase font-label">LED</p>
<p class="text-xl font-headline font-bold text-primary">384-BIT</p>
</div>
<div class="bg-surface-container p-4">
<p class="text-[10px] font-bold text-on-surface-variant tracking-widest uppercase font-label">Loại tản</p>
...
<span class="uppercase text-on-surface-variant">Kích thước radiator</span>
<span class="font-bold">16,384</span>
</li>
<li class="flex justify-between text-sm">
<span class="uppercase text-on-surface-variant">Loại tản nhiệt</span>
<span class="font-bold">128 (3RD GEN)</span>
</li>
<li class="flex justify-between text-sm">
<span class="uppercase text-on-surface-variant">Kích thước tản</span>
<span class="font-bold">128 (3RD GEN)</span>
</li>
<li class="flex justify-between text-sm">
<span class="uppercase text-on-surface-variant">Tương thích CPU</span>
<span class="font-bold">128 (3RD GEN)</span>
</li>
</ul>
</div>
...
<li class="flex justify-between text-sm">
<span class="uppercase text-on-surface-variant">Tốc độ quạt</span>
<span class="font-bold">GDDR6X</span>
</li>
<li class="flex justify-between text-sm">
<span class="uppercase text-on-surface-variant">Độ ồn</span>
<span class="font-bold">1,008 GB/S</span>
</li>
<li class="flex justify-between text-sm">
<span class="uppercase text-on-surface-variant">LED</span>
<span class="font-bold">1,008 GB/S</span>
</li>
</ul>
</div>
