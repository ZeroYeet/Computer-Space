...
<!-- Thanh điều hướng -->
<nav class="fixed top-0 w-full z-50 bg-slate-950/60 backdrop-blur-xl shadow-[0_20px_40px_rgba(0,0,0,0.4)]">
<div class="flex items-center justify-between px-8 py-4 max-w-[1920px] mx-auto">
<div class="flex items-center gap-8">
<span class="text-2xl font-bold tracking-tighter text-transparent bg-clip-text bg-gradient-to-br from-cyan-300 to-cyan-600 font-headline">Computer Space</span>
<div class="hidden md:flex items-center gap-6 font-headline tracking-tight text-sm">
<a class="text-slate-300 hover:text-cyan-200 transition-colors" href="#">Processors</a>
<a class="text-cyan-400 border-b-2 border-cyan-400 pb-1" href="#">Graphics Cards</a>
<a class="text-slate-300 hover:text-cyan-200 transition-colors" href="#">Memory</a>
<a class="text-slate-300 hover:text-cyan-200 transition-colors" href="#">Storage</a>
<a class="text-slate-300 hover:text-cyan-200 transition-colors" href="#">Motherboards</a>
<a class="text-slate-300 hover:text-cyan-200 transition-colors" href="#">Cooling</a>
<div class="relative hidden lg:block">
<input class="bg-surface-container-lowest border-none text-[10px] tracking-widest font-bold font-label px-4 py-2 w-64 focus:ring-1 focus:ring-primary-fixed-dim rounded-DEFAULT" placeholder="Tìm kiếm..." type="text"/>
...
<span class="material-symbols-outlined hover:text-cyan-400 cursor-pointer transition-colors">shopping_cart</span>
<span class="material-symbols-outlined hover:text-cyan-400 cursor-pointer transition-colors">account_circle</span>
</div>
</div>
</nav>
...
<span class="text-[10px] font-bold tracking-[0.2em] text-primary uppercase font-label">KINETIC_CORE SERIES</span>
<h2 class="text-3xl font-headline font-bold text-white tracking-tighter">QUANTUM TITAN X-1</h2>
</div>
</div>
...
<h1 class="text-5xl font-headline font-black tracking-tighter text-white">QUANTUM TITAN X-1</h1>
...
<p class="text-[10px] font-bold text-on-surface-variant tracking-widest uppercase font-label">Hãng</p>
<p class="text-xl font-headline font-bold text-primary">2.85 GHz</p>
</div>
<div class="bg-surface-container p-4">
<p class="text-[10px] font-bold text-on-surface-variant tracking-widest uppercase font-label">VRAM</p>
<p class="text-xl font-headline font-bold text-primary">24GB GDDR6X</p>
</div>
<div class="bg-surface-container p-4">
<p class="text-[10px] font-bold text-on-surface-variant tracking-widest uppercase font-label">Bus</p>
<p class="text-xl font-headline font-bold text-primary">384-BIT</p>
</div>
<div class="bg-surface-container p-4">
<p class="text-[10px] font-bold text-on-surface-variant tracking-widest uppercase font-label">TDP</p>
<p class="text-xl font-headline font-bold text-primary">450W</p>
</div>
</div>
<!-- thông tin cpu -->
<div class="grid grid-cols-2 gap-px bg-outline-variant/20 rounded-lg overflow-hidden">
...
<div class="bg-surface-container p-4">
<p class="text-[10px] font-bold text-on-surface-variant tracking-widest uppercase font-label">số nhân</p>
<p class="text-xl font-headline font-bold text-primary">24GB GDDR6X</p>
</div>
<div class="bg-surface-container p-4">
<p class="text-[10px] font-bold text-on-surface-variant tracking-widest uppercase font-label">xung nhịp</p>
<p class="text-xl font-headline font-bold text-primary">384-BIT</p>
</div>
<div class="bg-surface-container p-4">
<p class="text-[10px] font-bold text-on-surface-variant tracking-widest uppercase font-label">TDP</p>
...
<div class="flex items-center gap-2 text-on-surface-variant text-[10px] font-bold tracking-widest uppercase">
<span class="material-symbols-outlined text-sm">construction</span> Tư vấn kĩ thuật
                        </div>
</div>
</div>
</div>
...
<span class="text-on-surface-variant">VRAM</span>
<span class="font-bold">16,384</span>
</li>
<li class="flex justify-between text-sm">
<span class="uppercase text-on-surface-variant">Kiểu bộ nhớ</span>
<span class="font-bold">128 (3RD GEN)</span>
</li>
<li class="flex justify-between text-sm">
<span class="uppercase text-on-surface-variant">Bus</span>
<span class="font-bold">512 (4TH GEN)</span>
</li>
<li class="flex justify-between text-sm">
<span class="uppercase text-on-surface-variant">Xung nhịp</span>
<span class="font-bold">7680 X 4320</span>
</li>
</ul>
</div>
...
<li class="flex justify-between text-sm">
<span class="uppercase text-on-surface-variant">Số Quạt</span>
<span class="font-bold">GDDR6X</span>
</li>
<li class="flex justify-between text-sm">
<span class="uppercase text-on-surface-variant">Kích thước quạt</span>
<span class="font-bold">1,008 GB/S</span>
</li>
<li class="flex justify-between text-sm">
<span class="uppercase text-on-surface-variant">Đầu cấp nguồn</span>
<span class="font-bold">24 GB</span>
</li>
</ul>
</div>
</div>
</section>
<!-- Thông số kĩ thuật cho cpu -->
<section class="mt-32 space-y-12">
<div class="flex items-center gap-4">
<h3 class="text-2xl font-headline font-black tracking-widest uppercase text-white">Thông số kĩ thuật</h3>
<div class="h-px flex-1 bg-gradient-to-r from-outline-variant/50 to-transparent"></div>
...
<ul class="space-y-4 font-label">
<li class="flex justify-between text-sm">
<span class="text-on-surface-variant">Socket</span>
<span class="font-bold">16,384</span>
</li>
<li class="flex justify-between text-sm">
<span class="uppercase text-on-surface-variant">Số nhân</span>
<span class="font-bold">128 (3RD GEN)</span>
</li>
<li class="flex justify-between text-sm">
<span class="uppercase text-on-surface-variant">Số luồng</span>
<span class="font-bold">512 (4TH GEN)</span>
</li>
<li class="flex justify-between text-sm">
<span class="uppercase text-on-surface-variant">TDP</span>
<span class="font-bold">7680 X 4320</span>
</li>
</ul>
</div>
...
<ul class="space-y-4 font-label">
<li class="flex justify-between text-sm">
<span class="uppercase text-on-surface-variant">Xung nhịp cơ bản</span>
<span class="font-bold">21 GBPS</span>
</li>
<li class="flex justify-between text-sm">
<span class="uppercase text-on-surface-variant">Xung nhịp turbo</span>
<span class="font-bold">GDDR6X</span>
</li>
<li class="flex justify-between text-sm">
<span class="uppercase text-on-surface-variant">CacheL1</span>
<span class="font-bold">1,008 GB/S</span>
</li>
<li class="flex justify-between text-sm">
<span class="uppercase text-on-surface-variant">CacheL2</span>
<span class="font-bold">24 GB</span>
</li>
</ul>
</div>
...
<!-- Sản phẩm 1 -->
<div class="group relative bg-surface-container-low overflow-hidden">
