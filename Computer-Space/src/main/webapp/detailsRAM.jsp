...
<span class="uppercase text-on-surface-variant">Loại RAM</span>
...
<ul class="space-y-4 font-label">
<li class="flex justify-between text-sm">
<span class="uppercase text-on-surface-variant">Bus RAM</span>
<span class="font-bold">21 GBPS</span>
</li>
<li class="flex justify-between text-sm">
<span class="uppercase text-on-surface-variant">Điện áp</span>
<span class="font-bold">GDDR6X</span>
</li>
<li class="flex justify-between text-sm">
<span class="uppercase text-on-surface-variant">Số thanh</span>
