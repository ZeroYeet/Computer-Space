...
<p class="text-[10px] font-bold text-on-surface-variant tracking-widest uppercase font-label">Màu sắc</p>
<p class="text-xl font-headline font-bold text-primary">2.85 GHz</p>
</div>
<div class="bg-surface-container p-4">
<p class="text-[10px] font-bold text-on-surface-variant tracking-widest uppercase font-label">Chất liệu</p>
...
<div class="bg-surface-container p-4">
<p class="text-[10px] font-bold text-on-surface-variant tracking-widest uppercase font-label">Hỗ trợ main</p>
<p class="text-xl font-headline font-bold text-primary">2.85 GHz</p>
</div>
</div>
...
<span class="uppercase text-on-surface-variant">Màu sắc</span>
<span class="font-bold">16,384</span>
</li>
<li class="flex justify-between text-sm">
<span class="uppercase text-on-surface-variant">Chất liệu</span>
...
<li class="flex justify-between text-sm">
<span class="uppercase text-on-surface-variant">Kính cường lực</span>
<span class="font-bold">512 (4TH GEN)</span>
</li>
</ul>
</div>
...
<ul class="space-y-4 font-label">
<li class="flex justify-between text-sm">
<span class="uppercase text-on-surface-variant">Hỗ trợ main</span>
<span class="font-bold">21 GBPS</span>
</li>
<li class="flex justify-between text-sm">
<span class="uppercase text-on-surface-variant">Hỗ trợ nguồn</span>
<span class="font-bold">GDDR6X</span>
</li>
<li class="flex justify-between text-sm">
<span class="uppercase text-on-surface-variant">Số lượng quạt hỗ trợ</span>
<span class="font-bold">1,008 GB/S</span>
</li>
<li class="flex justify-between text-sm">
<span class="uppercase text-on-surface-variant">Cổng trước Case</span>
<span class="font-bold">1,008 GB/S</span>
</li>
</ul>
</div>
